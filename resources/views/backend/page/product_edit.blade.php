...
<form action="{{route('Product.update',$product->id)}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input name="product_description" type="text" class="form-control" id="p_des"  placeholder="Product Description">
  </div>

  <div class="form-group">
    <label for="p_quantity">Product quantity:</label>
    <input name="product_quantity" type="text" class="form-control" id="p_quantity"  placeholder=" Product quantity">
  </div>
  <div class="form-group">
